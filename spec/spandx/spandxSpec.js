...
describe("spandx", () => {
    ...
    //         frisby
    //         .fetch("http://localhost:1337", { headers: { "Content-Type": "text/html;"}})
    //             .expect("status", 200)
    ...
    //         frisby
    //             .fetch("http://localhost:1337", { headers: { "Content-Type": "text/html; charset=utf-8;"}})
    //             .expect("status", 200)
    //             .expect("bodyContains", /INDEX/)
    //             .done(done);
    //     });
    ...
    //         const { server, port } = await serve("spec/helpers/configs/js-or-json/", 4014);
    ...
    //     it("should accept overriding browserSync settings", async () => {
    //         const bs = await spandx.init("../spec/helpers/configs/bs-override/spandx.config.js")
    ...
    //         const bs = await spandx.init("../spec/helpers/configs/port-auto/spandx.config.js")
    //         const port = bs.getOption("port");
    //          frisby
    //             .fetch(`http://localhost:${port}/`, { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //               .expect("status", 200)
    //               .expect("bodyContains", /INDEX/)
    //               .done(done)
    //     });
    ...
    //         const bs = await spandx.init("../spec/helpers/configs/unconfigured-hostname/spandx.config.js")
    //         const port = bs.getOption("port");
    //         frisby
    //           .fetch(`http://127.0.0.1:${port}/`, { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //             .expect("status", 200)
    //             .expect("bodyContains", /INDEX/)
    //             .done(done)
    //     });
    ...
    //             frisby
    //                 .setup(accept)
    //             .fetch(`http://localhost:1337/foo`, { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                 .expect("status", 200)
    //                 .expect("bodyContains", /FOO/),
    //             frisby
    //                 .setup(accept)
    //               .fetch(`http://localhost:1337/foo/bar`, { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                 .expect("status", 200)
    //                 .expect("bodyContains", /FOO/),
    //             frisby
    //                 .setup(accept)
    //               .fetch(`http://localhost:1337/foo/bar/baz`, { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                 .expect("status", 200)
    //                 .expect("bodyContains", /FOO/),
    //         ];
    ...
    //             frisby
    //             .fetch(`http://localhost:1337/foo/bar/test.txt`, { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                 .expect("status", 200)
    ...
    //             );
    //             frisby
    //               .fetch("http://localhost:1337/esi-abs-paths.html", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                 .expect("status", 200)
    ...
    //                 );
    //                 frisby
    //                   .fetch("http://localhost:1337/esi-domain-rel-paths.html", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                     .expect("status", 200)
    ...
    //                 );
    //                 frisby
    //                   .fetch("http://localhost:1337/esi-file-rel-paths.html", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                     .expect("status", 200)
    ...
    //                 );
    //                 frisby
    //                   .fetch("https://localhost:1337/esi-domain-rel-paths.html", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                     .expect("status", 200)
    //                     .expect("bodyContains", /ESI DOMAIN REL PATH PARENT/)
    //                     .expect("bodyContains", /ABS PATH ROOT SNIPPET/)
    //                     .expect("bodyContains", /ABS PATH SUBDIR SNIPPET/)
    ...
    //             );
    //             frisby
    //               .fetch("http://localhost:1337/subdir", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
    //                 .expect("status", 200)
    ...
    describe("portal chrome", () => {
        ...
        //       .fetch("http://localhost:1337/test-page.html", { headers: { "Content-Type": "text/html; charset=utf-8;" } } );
        ...
        //       .fetch("http://127.0.0.1:1337/test-page.html",  { headers: { "Content-Type": "text/html; charset=utf-8;" } });
        ...
        it("should rewrite body URLs within Portal Chrome snippets, on single host routes", async () => {
            const { server, port } = await serve(
                "spec/helpers/configs/portal-chrome/",
                4014
            );
            ...
            const res = await frisby.fetch(
                "http://localhost:1337/test-page.html"
            );
        ...
        it("should rewrite body URLs within Portal Chrome snippets, on multi host routes", async (done) => {
            ...
            const res2 = await frisby.fetch(
                "http://127.0.0.1:1337/test-page.html",
                { headers: { "Content-Type": "text/html; charset=utf-8;" } }
            );
    ...
    describe("URL rewriting", () => {
        describe("when routing to local directories", () => {
            it("should rewrite body URLs to match the spandx origin", async () => {
                await spandx.init(
        ...
        describe("when routing to remote directories", () => {
            it("should honor the path setting when resolving a route", async () => {
                const { server, port } = await serve(
                ...
                frisby
                    ...
                    // .expect("status", 200)
                    // .expect("bodyContains", /path-setting/)
                    // .fetch("http://localhost:1337/realfoo/", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
                    // .expect("status", 200)
                    // .expect("bodyContains", /foo/)
                    .fetch("http://localhost:1337/realfoo/bar/", {
                        headers: {
                            "Content-Type": "text/html; charset=utf-8;",
                        },
                    })
                    ...
                    // .fetch("http://localhost:1337/realbar/", { headers: { "Content-Type": "text/html; charset=utf-8;" } })
                    // .expect("status", 200)
                    // .expect("bodyContains", /bar/)
                    .then(() => {
                        server.close();
    ...
    describe("remote fallback", () => {
        it("if a file is not found on a local route, attempt to fetch it from the '/' remote route", async () => {
            const { server, port } = await serve(
            ...
            frisby
                .fetch("http://localhost:1337/subdir/remote-only.html", {
                    headers: { "Content-Type": "text/html; charset=utf-8;" },
                })
                .expect("status", 200)
        ...
        it("if a file exists in both a local route and a remote '/' route, serve the local one", async () => {
            const { server, port } = await serve(
                "spec/helpers/configs/remote-fallback/remote-files",
                4014
            );
            ...
            frisby
                .fetch("http://localhost:1337/subdir/index.html", {
                    headers: { "Content-Type": "text/html; charset=utf-8;" },
                })
                .expect("status", 200)
        ...
        it("if the remote is unreachable, return bad gateway", async () => {
            await spandx.init(
    ...
    describe("routing order", () => {
        it("should pick longer routes over shorter routes", async () => {
            const { server, port } = await serve(
            ...
            frisby
                ...
                .expect("status", 200)
                .expect("bodyContains", /^\//)
                .fetch("http://localhost:1337/a")
                .expect("status", 200)
                .expect("bodyContains", /^\/a/)
                .fetch("http://localhost:1337/a/b")
                .expect("status", 200)
                .expect("bodyContains", /^\/a\/b/)
                .fetch("http://localhost:1337/a/b/c")
                .expect("status", 200)
    ...
    //     });
    //     it("can be executed with no arguments", async () => {
    ...
    //         });
    //     });
    //     it("-c should accept a relative config file path", async () => {
    //         // launch spandx and scan the output for desired strings
    ...
    //         });
    //     });
    //     it("-c should accept a absolute config file path", async () => {
    //         // launch spandx and scan the output for desired strings
    //         const shell = execFile(`app/cli.js`, [
    //             `-c`,
