...
Starting with spandx 2.2.4, spandx configs generated with `spandx init cp` include code for automatically detecting and using certs generated by the mkcert command.

Don't forget to gitignore the certs.
